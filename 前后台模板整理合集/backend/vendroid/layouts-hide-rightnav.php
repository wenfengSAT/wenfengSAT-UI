...
<head>
    <meta charset="utf-8" />
    <title>Layouts Hide Right Navigation HTML Template - Responsive Multipurpose Admin Templates | Vendroid</title>
    <meta name="keywords" content="HTML5 Template, CSS3, All Purpose Admin Template, Vendroid" />
    <meta name="description" content="Layouts Hide Right Navigation - Responsive Admin HTML Template">
...
<body id="layouts" class="full-layout  nav-right-hide nav-right-start-hide  nav-top-fixed      responsive    clearfix" data-active="layouts "  data-smooth-scrolling="1">     
<div class="vd_body">
<!-- Header Start -->
...
</div>    <div class="vd_navbar vd_nav-width vd_navbar-email vd_bg-black-80 vd_navbar-right  vd_navbar-style-2">
	<div class="navbar-tabs-menu clearfix">
			<span class="expand-menu" data-action="expand-navbar-tabs-menu">
            	<span class="menu-icon menu-icon-left">
            		<i class="fa fa-ellipsis-h"></i>
