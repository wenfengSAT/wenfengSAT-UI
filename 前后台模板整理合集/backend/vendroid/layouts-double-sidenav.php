...
<head>
    <meta charset="utf-8" />
    <title>Layout Double Side Nav HTML Template - Responsive Multipurpose Admin Templates | Vendroid</title>
...
</div>    <div class="vd_navbar vd_nav-width vd_navbar-no-tab vd_navbar-right  vd_bg-grey">
	<div class="navbar-menu clearfix">
        <div class="vd_panel-menu hidden-xs">
