...
<head>
    <meta charset="utf-8" />
    <title>Vendroid Custom Functions - Responsive Multipurpose Admin Templates | Vendroid</title>
    <meta name="keywords" content="HTML5 Template, CSS3, All Purpose Admin Template, Vendroid" />
    <meta name="description" content="Vendroid Custom Functions - Responsive Admin HTML Template">
...
<body id="nav" class="full-layout    nav-top-fixed   nav-right-medium   responsive    clearfix" data-active="nav "  data-smooth-scrolling="1">     
<div class="vd_body">
<!-- Header Start -->
...
</div>    <div class="vd_navbar vd_nav-width vd_navbar-tabs-menu vd_navbar-right   vd_bg-black-60">
	<div class="navbar-tabs-menu clearfix">
			<span class="expand-menu" data-action="expand-navbar-tabs-menu">
            	<span class="menu-icon menu-icon-left">
            		<i class="fa fa-ellipsis-h"></i>
