...
<head>
    <meta charset="utf-8" />
    <title>Layouts Simple HTML Template - Responsive Multipurpose Admin Templates | Vendroid</title>
...
<body id="layouts" class="boxed-layout  no-nav-right  nav-top-fixed vd_bg-soft-grey nav-left-medium    no-responsive    clearfix" data-active="layouts "  data-smooth-scrolling="1">     
<div class="vd_body">
<!-- Header Start -->
