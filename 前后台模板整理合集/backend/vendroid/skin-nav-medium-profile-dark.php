...
<head>
    <meta charset="utf-8" />
    <title>Skin Dark Medium HTML Template - Responsive Multipurpose Admin Templates | Vendroid</title>
...
<!-- Header Start -->
  <header class="header-1" id="header">
      <div class="vd_top-menu-wrapper">
        <div class="container vd_bg-dark-blue  menu-search-style-2">
...
<div class="content">
  <div class="container">
    <div class="vd_navbar vd_nav-width vd_navbar-tabs-profile vd_navbar-left vd_navbar-style-2 background-1 ">
