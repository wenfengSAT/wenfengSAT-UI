...
<li>
<a href="page_app_email.php" class=" active"><i class="gi gi-inbox sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Email Center</span></a>
</li>
<li>
...
</div><div id="modal-compose" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
...
<script src="js/app-2.4.js"></script><script src="js/pages/appEmail.js"></script>
