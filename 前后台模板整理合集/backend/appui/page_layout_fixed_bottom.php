...
<div id="page-container" class="header-fixed-bottom sidebar-visible-lg-full enable-cookies">
...
<li>
<a href="page_layout_fixed_bottom.php" class=" active">Bottom Header (Fixed)</a>
</li>
<li>
