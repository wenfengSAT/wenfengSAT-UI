...
<html>
  <head>
    <title>Minimal 1.3 - Timeline</title>
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="timeline.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="timeline.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="timeline.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="cyan" href="timeline.html#">
                  ...
                  <li>
                    <a class="green" href="timeline.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="red" href="timeline.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="orange" href="timeline.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="timeline.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="timeline.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="timeline.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="timeline.html#" class="bg-1"></a></li>
                      <li><a href="timeline.html#" class="bg-2"></a></li>
                      <li><a href="timeline.html#" class="bg-3"></a></li>
                      <li><a href="timeline.html#" class="bg-4"></a></li>
                      <li><a href="timeline.html#" class="bg-5"></a></li>
                      <li><a href="timeline.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="timeline.html#" class="solid-bg-1"></a></li>
                      <li><a href="timeline.html#" class="solid-bg-2"></a></li>
                      <li><a href="timeline.html#" class="solid-bg-3"></a></li>
                      <li><a href="timeline.html#" class="solid-bg-4"></a></li>
                      <li><a href="timeline.html#" class="solid-bg-5"></a></li>
                      <li><a href="timeline.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="timeline.html#" class="video-bg-1"></a></li>
                      <li><a href="timeline.html#" class="video-bg-2"></a></li>
                      <li><a href="timeline.html#" class="video-bg-3"></a></li>
                      <li><a href="timeline.html#" class="video-bg-4"></a></li>
                      <li><a href="timeline.html#" class="video-bg-5"></a></li>
                      <li><a href="timeline.html#" class="video-bg-6"></a></li>
                      <li><a href="timeline.html#" class="video-bg-7"></a></li>
                      <li><a href="timeline.html#" class="video-bg-8"></a></li>
                      <li><a href="timeline.html#" class="video-bg-9"></a></li>
                      <li><a href="timeline.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="timeline.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="timeline.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="timeline.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="timeline.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="timeline.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="timeline.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="timeline.html#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="timeline.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="timeline.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="timeline.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="timeline.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="timeline.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="timeline.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="timeline.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="timeline.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="timeline.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-clock-o" style="line-height: 48px;padding-left: 0;"></i> Timeline <span>// Place subtitle here...</span></h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="timeline.html#">Example Pages</a></li>
                ...
                <ol class="timeline">
                  ...
                  <li class="color transparent-black">
                    ...
                    <div class="el-container">
                      ...
                      <div class="content">
                        ...
                        <h1><strong>Left Side</strong> Icon</h1>
                  ...
                  <li class="color transparent-black textured">
                    <div class="pointer slategray">
                     ...
                     <div class="el-container">
                      <div class="content">
                        <span class="time"><i class="fa fa-clock-o"></i> Today, 03:15pm</span>
                        <h1><strong>Right Side</strong> Icon</h1>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                      </div>
                      <div class="side"><i class="fa fa-cog"></i></div>
                    </div>
                  </li> 
                  ...
                  <li class="color transparent-white">
                    ...
                    <div class="el-container">
                      <div class="side"><img src="assets/images/carousel/carousel1.jpg" alt></div>
                      <div class="content">
                        <span class="time"><i class="fa fa-clock-o"></i> Today, 03:12pm</span>
                        <h1><strong>Left Side</strong> Image</h1>
                    ...
                    <div class="pointer slategray">
                     ...
                     <div class="el-container">
                      <div class="content">
                        ...
                        <h1><strong>Right Side</strong> Image</h1>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                      </div>
                      <div class="side"><img src="assets/images/carousel/carousel2.jpg" alt></div>
                    </div>
                  </li>
                  ...
                  <li class="color transparent-black">
                    <div class="pointer slategray">
                     ...
                     <div class="el-container">
                      <div class="content">
                        <span class="time"><i class="fa fa-clock-o"></i> Yesterday, 18:40pm</span>
                        <h1><strong>Top</strong> Icon</h1>
                  ...
                  <li class="color red">
                    <div class="pointer red">
                     ...
                     <div class="el-container">
                      <div class="content">
                        <span class="time"><i class="fa fa-clock-o"></i> Yesterday, 13:22pm</span>
                  ...
                  <li class="full-width">
                    <div class="pointer slategray">
                     ...
                     <div class="el-container">
                      <div class="content">
                        <span class="time"><i class="fa fa-clock-o"></i> Yesterday, 10:18am</span>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="timeline.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="timeline.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="timeline.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="timeline.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="timeline.html#">
