...
<html>
  <head>
    <title>Minimal 1.3 - Buttons & Icons</title>
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="buttons.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="buttons.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="buttons.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="cyan" href="buttons.html#">
                  ...
                  <li>
                    <a class="green" href="buttons.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="orange" href="buttons.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="buttons.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="buttons.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="buttons.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="buttons.html#" class="bg-1"></a></li>
                      <li><a href="buttons.html#" class="bg-2"></a></li>
                      <li><a href="buttons.html#" class="bg-3"></a></li>
                      <li><a href="buttons.html#" class="bg-4"></a></li>
                      <li><a href="buttons.html#" class="bg-5"></a></li>
                      <li><a href="buttons.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="buttons.html#" class="solid-bg-1"></a></li>
                      <li><a href="buttons.html#" class="solid-bg-2"></a></li>
                      <li><a href="buttons.html#" class="solid-bg-3"></a></li>
                      <li><a href="buttons.html#" class="solid-bg-4"></a></li>
                      <li><a href="buttons.html#" class="solid-bg-5"></a></li>
                      <li><a href="buttons.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="buttons.html#" class="video-bg-1"></a></li>
                      <li><a href="buttons.html#" class="video-bg-2"></a></li>
                      <li><a href="buttons.html#" class="video-bg-3"></a></li>
                      <li><a href="buttons.html#" class="video-bg-4"></a></li>
                      <li><a href="buttons.html#" class="video-bg-5"></a></li>
                      <li><a href="buttons.html#" class="video-bg-6"></a></li>
                      <li><a href="buttons.html#" class="video-bg-7"></a></li>
                      <li><a href="buttons.html#" class="video-bg-8"></a></li>
                      <li><a href="buttons.html#" class="video-bg-9"></a></li>
                      <li><a href="buttons.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="buttons.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="buttons.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="buttons.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="buttons.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="buttons.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="buttons.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="buttons.html#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="buttons.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="buttons.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="buttons.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="buttons.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="buttons.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="buttons.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="buttons.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="buttons.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="buttons.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tint" style="line-height: 50px;padding-left: 0;"></i> Buttons & Icons <span>// Place subtitle here...</span></h2>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header">
                    <h1><strong>Button</strong> Types</h1>
                    <div class="controls">
                      <a href="buttons.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="buttons.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="buttons.html#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
                  </div>
                  <!-- /tile header -->
                  ...
                  <div class="tile-body ">
                   ...
                   <h4><strong>Button</strong> Sizing</h4>
                    <p>
                      <button type="button" class="btn btn-primary btn-lg margin-bottom-20">Large button</button>
                      <button type="button" class="btn btn-default btn-lg margin-bottom-20">Large button</button>
                      <button type="button" class="btn btn-primary margin-bottom-20">Default button</button>
                      <button type="button" class="btn btn-default margin-bottom-20">Default button</button>
                      <button type="button" class="btn btn-primary btn-sm margin-bottom-20">Small button</button>
                      <button type="button" class="btn btn-default btn-sm margin-bottom-20">Small button</button>
                      <button type="button" class="btn btn-primary btn-xs margin-bottom-20">Extra small button</button>
                      <button type="button" class="btn btn-default btn-xs margin-bottom-20">Extra small button</button>
                    </p>

                    <h4><strong>Button</strong> Colors</h4>
                    <p>
                      <button type="button" class="btn btn-default margin-bottom-20">Default</button>
                      <button type="button" class="btn btn-primary margin-bottom-20">Primary</button>
                      <button type="button" class="btn btn-success margin-bottom-20">Success</button>
                      <button type="button" class="btn btn-info margin-bottom-20">Info</button>
                      <button type="button" class="btn btn-warning margin-bottom-20">Warning</button>
                      <button type="button" class="btn btn-danger margin-bottom-20">Danger</button>
                      <button type="button" class="btn btn-red margin-bottom-20">Red</button>
                      <button type="button" class="btn btn-cyan margin-bottom-20">Cyan</button>
                      <button type="button" class="btn btn-green margin-bottom-20">Green</button>
                      <button type="button" class="btn btn-orange margin-bottom-20">Orange</button>
                      <button type="button" class="btn btn-amethyst margin-bottom-20">Amethyst</button>
                      <button type="button" class="btn btn-greensea margin-bottom-20">Greensea</button>
                      <button type="button" class="btn btn-dutch margin-bottom-20">Dutch</button>
                      <button type="button" class="btn btn-hotpink margin-bottom-20">Hotpink</button>
                      <button type="button" class="btn btn-drank margin-bottom-20">Drank</button>
                      <button type="button" class="btn btn-blue margin-bottom-20">Blue</button>
                      <button type="button" class="btn btn-redbrown margin-bottom-20">Redbrown</button>
                      <button type="button" class="btn btn-slategray margin-bottom-20">Slategray</button>
                      <button type="button" class="btn btn-link margin-bottom-20">Link</button>
                    </p>
                ...
                <section class="tile color transparent-black">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Button</strong> Dropdowns</h1>
                    <div class="controls">
                      <a href="buttons.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="buttons.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="buttons.html#" class="remove"><i class="fa fa-times"></i></a>
                  ...
                  <div class="tile-body ">
                   ...
                   <!-- Single button -->
                    ...
                    <!-- Split button -->
                    <div class="btn-group margin-bottom-20">
                      <button type="button" class="btn btn-red">Split</button>
                      <button type="button" class="btn btn-red dropdown-toggle" data-toggle="dropdown">
                        <span class="caret"></span>
                        <span class="sr-only">Toggle Dropdown</span>
                      </button>
                    ...
                    <!-- Single button -->
                    <div class="btn-group dropup margin-bottom-20">
                      <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    ...
                    <!-- Split button -->
                    <div class="btn-group dropup margin-bottom-20">
                      <button type="button" class="btn btn-red">Split Dropup</button>
                      <button type="button" class="btn btn-red dropdown-toggle" data-toggle="dropdown">
                        <span class="caret"></span>
                        <span class="sr-only">Toggle Dropdown</span>
                      </button>
                    ...
                    <div class="notification notification-cyan">
              ...
              <div class="col-md-6">
                ...
                <section class="tile color transparent-white">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Button</strong> Groups</h1>
                    <div class="controls">
                      <a href="buttons.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="buttons.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="buttons.html#" class="remove"><i class="fa fa-times"></i></a>
                  ...
                  <div class="tile-body ">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="btn-toolbar margin-bottom-20" role="toolbar">
                          <div class="btn-group">
                        ...
                        <h4><strong>Button Groups</strong> Sizing</h4>
                        <div class="btn-toolbar margin-bottom-20" role="toolbar">
                      ...
                      <div class="col-sm-6">
                        ...
                        <h4><strong>Vertical</strong> Variation</h4>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <h4><strong>Justified</strong> link variation</h4>
                ...
                <div class="notification notification-green">
                  <h4><strong>Icons</strong> List</h4>
                  <p>Check <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">FontAwesome site</a> for icons list.</p>
                </div>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="buttons.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="buttons.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="buttons.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="buttons.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="buttons.html#">
