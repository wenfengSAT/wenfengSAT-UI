      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="tiles.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="tiles.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="tiles.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="orange" href="tiles.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="tiles.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="tiles.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="tiles.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="tiles.html#" class="bg-1"></a></li>
                      <li><a href="tiles.html#" class="bg-2"></a></li>
                      <li><a href="tiles.html#" class="bg-3"></a></li>
                      <li><a href="tiles.html#" class="bg-4"></a></li>
                      <li><a href="tiles.html#" class="bg-5"></a></li>
                      <li><a href="tiles.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="tiles.html#" class="solid-bg-1"></a></li>
                      <li><a href="tiles.html#" class="solid-bg-2"></a></li>
                      <li><a href="tiles.html#" class="solid-bg-3"></a></li>
                      <li><a href="tiles.html#" class="solid-bg-4"></a></li>
                      <li><a href="tiles.html#" class="solid-bg-5"></a></li>
                      <li><a href="tiles.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="tiles.html#" class="video-bg-1"></a></li>
                      <li><a href="tiles.html#" class="video-bg-2"></a></li>
                      <li><a href="tiles.html#" class="video-bg-3"></a></li>
                      <li><a href="tiles.html#" class="video-bg-4"></a></li>
                      <li><a href="tiles.html#" class="video-bg-5"></a></li>
                      <li><a href="tiles.html#" class="video-bg-6"></a></li>
                      <li><a href="tiles.html#" class="video-bg-7"></a></li>
                      <li><a href="tiles.html#" class="video-bg-8"></a></li>
                      <li><a href="tiles.html#" class="video-bg-9"></a></li>
                      <li><a href="tiles.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="tiles.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="tiles.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="tiles.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="tiles.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="tiles.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="tiles.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="tiles.html#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="tiles.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="tiles.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="tiles.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="tiles.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="tiles.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="tiles.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="tiles.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="tiles.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="tiles.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-th" style="line-height: 50px;padding-left: 2px;"></i> Tiles <span>// Place subtitle here...</span></h2>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <section class="tile">
                  ...
                  <div class="tile-header">
                    <h1><strong>Basic</strong> Tile</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
                  </div>
                  <!-- /tile header -->
                ...
                <section class="tile color redbrown">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Colored Tile</strong> Redbrown</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile">
                  ...
                  <div class="tile-header color slategray rounded-top-corners">
                    <h1><strong>Colored Header</strong> Slategray</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                  ...
                  <!-- tile widget -->
                  <div class="tile-widget color drank">

                    <p>This is colored .drank tile widget area.</p>
                  ...
                  <div class="tile-body color dutch">
                    ...
                    <p>This is colored .dutch tile body area.</p>

                  </div>
                  <!-- /tile body -->

                   <!-- tile footer -->
                  <div class="tile-footer color blue rounded-bottom-corners">
                    
                    <p>This is colored .blue tile footer area.</p>
                ...
                <section class="tile transparent">
                  ...
                  <!-- tile header -->
                  <div class="tile-header color cyan text-center rounded-top-corners">               
                    <button class="btn pull-left btn-black-transparent" type="button"><i class="fa fa-caret-square-o-down"></i></button>
                    <h1 class="small-uppercase"><strong>Heading</strong> with button</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                  ...
                  <!-- tile widget -->
                  <div class="tile-widget color transparent-black">
              ...
              <div class="col-md-4">
                ...
                <section class="tile color transparent-black">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Transparent Black</strong> Tile</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile color blue">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Colored Tile</strong> Blue</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile color transparent-black textured">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Transparent Textured</strong> Tile</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile transparent">
                  ...
                  <div class="tile-header transparent">
                    <h1><strong>Transparent Header</strong> Tile</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
              ...
              <div class="col-md-4">
                ...
                <section class="tile color transparent-white">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Transparent White</strong> Tile</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile color greensea">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Colored Tile</strong> Greensea</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile color red">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1 class="small-uppercase"><strong>Uppercased</strong> Heading</h1>
                    <div class="controls">
                      <a href="tiles.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tiles.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tiles.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile">
                  ...
                  <div class="tile-widget">
                    ...
                    <p><strong>Tile without heading.</strong> This is tile widget area.</p>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="tiles.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="tiles.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="tiles.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="tiles.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="tiles.html#">
