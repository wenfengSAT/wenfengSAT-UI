...
<html>
  <head>
    <title>Minimal 1.3 - Invoice</title>
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="invoice.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="invoice.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="invoice.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="cyan" href="invoice.html#">
                  ...
                  <li>
                    <a class="green" href="invoice.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="orange" href="invoice.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="invoice.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="invoice.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="invoice.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="invoice.html#" class="bg-1"></a></li>
                      <li><a href="invoice.html#" class="bg-2"></a></li>
                      <li><a href="invoice.html#" class="bg-3"></a></li>
                      <li><a href="invoice.html#" class="bg-4"></a></li>
                      <li><a href="invoice.html#" class="bg-5"></a></li>
                      <li><a href="invoice.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="invoice.html#" class="solid-bg-1"></a></li>
                      <li><a href="invoice.html#" class="solid-bg-2"></a></li>
                      <li><a href="invoice.html#" class="solid-bg-3"></a></li>
                      <li><a href="invoice.html#" class="solid-bg-4"></a></li>
                      <li><a href="invoice.html#" class="solid-bg-5"></a></li>
                      <li><a href="invoice.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="invoice.html#" class="video-bg-1"></a></li>
                      <li><a href="invoice.html#" class="video-bg-2"></a></li>
                      <li><a href="invoice.html#" class="video-bg-3"></a></li>
                      <li><a href="invoice.html#" class="video-bg-4"></a></li>
                      <li><a href="invoice.html#" class="video-bg-5"></a></li>
                      <li><a href="invoice.html#" class="video-bg-6"></a></li>
                      <li><a href="invoice.html#" class="video-bg-7"></a></li>
                      <li><a href="invoice.html#" class="video-bg-8"></a></li>
                      <li><a href="invoice.html#" class="video-bg-9"></a></li>
                      <li><a href="invoice.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="invoice.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="invoice.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="invoice.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="invoice.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="invoice.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="invoice.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="invoice.html#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="invoice.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="invoice.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="invoice.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="invoice.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="invoice.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="invoice.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="invoice.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="invoice.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="invoice.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-file-o" style="line-height: 48px;padding-left: 2px;"></i> Invoice <span>// Place subtitle here...</span></h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="invoice.html#">Example Pages</a></li>
                ...
                <section class="invoice">
                  ...
                  <div class="header">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <h3><strong>July 7th</strong>, 2014</h3>
                        ...
                        <address>
                          ...
                          Jimmy Bettery<br/>
                          <a href="invoice.html#">jim.bettery@themeforest.com</a>
                        </address>
                      ...
                      <div class="col-md-4 text-right">
                        <h3><strong>Invoice</strong> #001242014</h3>
                        ...
                        <address>
                          ...
                          John Douey<br/>
                          <a href="invoice.html#">john.douey@lorem.com</a>
                        </address>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="invoice.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="invoice.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="invoice.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="invoice.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="invoice.html#">
