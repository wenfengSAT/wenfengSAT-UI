      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="mail.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="mail.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="mail.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li class="topborder"><a href="mail.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="mail.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="mail.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="mail.html#" class="bg-1"></a></li>
                      <li><a href="mail.html#" class="bg-2"></a></li>
                      <li><a href="mail.html#" class="bg-3"></a></li>
                      <li><a href="mail.html#" class="bg-4"></a></li>
                      <li><a href="mail.html#" class="bg-5"></a></li>
                      <li><a href="mail.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="mail.html#" class="solid-bg-1"></a></li>
                      <li><a href="mail.html#" class="solid-bg-2"></a></li>
                      <li><a href="mail.html#" class="solid-bg-3"></a></li>
                      <li><a href="mail.html#" class="solid-bg-4"></a></li>
                      <li><a href="mail.html#" class="solid-bg-5"></a></li>
                      <li><a href="mail.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="mail.html#" class="video-bg-1"></a></li>
                      <li><a href="mail.html#" class="video-bg-2"></a></li>
                      <li><a href="mail.html#" class="video-bg-3"></a></li>
                      <li><a href="mail.html#" class="video-bg-4"></a></li>
                      <li><a href="mail.html#" class="video-bg-5"></a></li>
                      <li><a href="mail.html#" class="video-bg-6"></a></li>
                      <li><a href="mail.html#" class="video-bg-7"></a></li>
                      <li><a href="mail.html#" class="video-bg-8"></a></li>
                      <li><a href="mail.html#" class="video-bg-9"></a></li>
                      <li><a href="mail.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="mail.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="mail.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="mail.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="mail.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="mail.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="mail.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="mail.html#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="mail.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="mail.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="mail.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="mail.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="mail.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="mail.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="mail.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="mail.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="mail.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
          ...
          <div class="pageheader">
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="mail.html#">Example Pages</a></li>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                ...
                <ul class="navigation" id="mail-navigation">
                  ...
                  <li class="compose"><a href="mail.html#" class="btn btn-red">Compose Mail</a></li>
                  <li class="folders heading">
                    <h5><i class="fa fa-folder"></i> Folders <a href="mail.html#" class="pull-right"><i class="fa fa-plus"></i></a></h5>
                    <ul>
                      <li class="active"><a href="mail.html#"><span class="badge badge-red">5</span>Inbox</a></li>
                      <li><a href="mail.html#">Sent</a></li>
                      <li><a href="mail.html#">Draft</a></li>
                      <li><a href="mail.html#">Trash</a></li>
                      <li class="divider"></li>
                      <li class="other"><a href="mail.html#">Private</a></li>
                      <li class="other"><a href="mail.html#">Work</a></li>
                    </ul>
                  </li>
                  <li class="labels heading">
                    <h5><i class="fa fa-tags"></i> Labels <a href="mail.html#" class="pull-right"><i class="fa fa-plus"></i></a></h5>
                    <ul>
                      <li class="tag"><a href="mail.html#">Family <span class="label label-cyan"></span></a></li>
                      <li class="tag"><a href="mail.html#">Work <span class="label label-red"></span></a></li>
                      <li class="tag"><a href="mail.html#">Shop <span class="label label-orange"></span></a></li>
                      <li class="tag"><a href="mail.html#">Themeforest <span class="label label-amethyst"></span></a></li>
                      <li class="tag"><a href="mail.html#">Google <span class="label label-green"></span></a></li>
                      <li class="tag"><a href="mail.html#">Facebook <span class="label label-hotpink"></span></a></li>
                    </ul>
                </ul>
              ...
              <div class="col-md-3">
                ...
                <ul class="inbox" id="mail-inbox">
                  ...
                  <li class="msg">
                    ...
                    <a href="mail.html#" class="mail-favourite active"><i class="fa fa-star-o"></i></a>
                    <div>
                      ...
                      <div class="mail-actions">
                        <a href="mail.html#" class="reply"><i class="fa fa-reply"></i></a> 
                        <a href="mail.html#" class="delete"><i class="fa fa-trash-o"></i></a>
                      </div>
                    </div>
                  </li>
                  <li class="msg">
                    ...
                    <a href="mail.html#" class="mail-favourite"><i class="fa fa-star-o"></i></a>
                    <div>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="mail.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="mail.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="mail.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="mail.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="mail.html#">
