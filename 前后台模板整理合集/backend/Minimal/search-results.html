...
<html>
  <head>
    <title>Minimal 1.3 - Search Results</title>
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="search-results.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="search-results.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="search-results.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="cyan" href="search-results.html#">
                  ...
                  <li>
                    <a class="green" href="search-results.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="red" href="search-results.html#">
                      <div class="profile-photo">
                  ...
                  <li>
                    <a class="orange" href="search-results.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="search-results.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="search-results.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="search-results.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="search-results.html#" class="bg-1"></a></li>
                      <li><a href="search-results.html#" class="bg-2"></a></li>
                      <li><a href="search-results.html#" class="bg-3"></a></li>
                      <li><a href="search-results.html#" class="bg-4"></a></li>
                      <li><a href="search-results.html#" class="bg-5"></a></li>
                      <li><a href="search-results.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="search-results.html#" class="solid-bg-1"></a></li>
                      <li><a href="search-results.html#" class="solid-bg-2"></a></li>
                      <li><a href="search-results.html#" class="solid-bg-3"></a></li>
                      <li><a href="search-results.html#" class="solid-bg-4"></a></li>
                      <li><a href="search-results.html#" class="solid-bg-5"></a></li>
                      <li><a href="search-results.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="search-results.html#" class="video-bg-1"></a></li>
                      <li><a href="search-results.html#" class="video-bg-2"></a></li>
                      <li><a href="search-results.html#" class="video-bg-3"></a></li>
                      <li><a href="search-results.html#" class="video-bg-4"></a></li>
                      <li><a href="search-results.html#" class="video-bg-5"></a></li>
                      <li><a href="search-results.html#" class="video-bg-6"></a></li>
                      <li><a href="search-results.html#" class="video-bg-7"></a></li>
                      <li><a href="search-results.html#" class="video-bg-8"></a></li>
                      <li><a href="search-results.html#" class="video-bg-9"></a></li>
                      <li><a href="search-results.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="search-results.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="search-results.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="search-results.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="search-results.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="search-results.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="search-results.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="search-results.html#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="search-results.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="search-results.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="search-results.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="search-results.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="search-results.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="search-results.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="search-results.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="search-results.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="search-results.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
        ...
        <div id="content" class="col-md-12 chat">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-search" style="line-height: 46px;padding-left: 0;"></i> Search Results <span>// Place subtitle here...</span></h2>
            ...
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                ...
                <li><a href="search-results.html#">Example Pages</a></li>
                ...
                <section class="tile transparent">
                  ...
                  <div class="tile-widget nopadding color transparent-black rounded-top-corners">
                    ...
                    <ul class="nav nav-tabs tabdrop align-right">
                      <li class="tab-title pull-left">
                        <h4 class="search-result thin"><strong>36</strong> Search results for: <span class="search-string">"imrich"</span></h4>
                      </li>
                      <li class="active"><a href="search-results.html#fulltext-tab" data-toggle="tab">Fulltext <small>(30)</small></a></li>
                      <li><a href="search-results.html#files-tab" data-toggle="tab">Files <small>(5)</small></a></li>
                      <li><a href="search-results.html#users-tab" data-toggle="tab">Users <small>(1)</small></a></li>
                    </ul>
                    <!-- / Nav tabs -->
                  </div>
                  <!-- /tile widget -->
                  ...
                  <div class="tile-body tab-content rounded-bottom-corners">
                    ...
                    <div class="input-group search-bar">
                      <input type="text" class="form-control" name="search" placeholder="Search..." value="imrich">
                      ...
                      <ul class="search-results fulltext">
                        ...
                        <li class="search-result">
                          <div class="cover">
                            ...
                            <h4><a href="http://tattek.com/minoral">Dashboard</a></h4>

                            <p> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>

                            <a href="http://tattek.com/minoral">http://tattek.com/minoral</a>
                        ...
                        <li class="search-result">
                          <div class="cover">
                            ...
                            <h4><a href="http://tattek.com/minoral/form-elements.html">Form Elements</a></h4>

                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>

                            <a href="http://tattek.com/minoral/form-elements.html">http://tattek.com/minoral/form-elements.html</a>
                        ...
                        <li class="search-result">
                          <div class="cover">
                            ...
                            <h4><a href="http://tattek.com/minoral/timeline.html">Timeline</a></h4>

                            <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur?</p>

                            <a href="http://tattek.com/minoral/timeline.html">http://tattek.com/minoral/timeline.html</a>
                        ...
                        <li class="search-result">
                          ...
                          <h4><a href="http://tattek.com/minoral/mail.html">Inbox</a></h4>

                          <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful.</p>

                          <a href="http://tattek.com/minoral/mail.html">http://tattek.com/minoral/mail.html</a>
                    ...
                    <div id="files-tab" class="tab-pane fade in">
                        ...
                        <div class="panel panel-default">
                          ...
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" data-parent="#accordion" href="search-results.html#collapseOne" class="">
                                Refine Results
                              </a>
                            </h4>
                          </div>
                            ...
                            <div class="panel-body">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12">
                                  ...
                                  <div class="noUiSlider rangeSlider connect-greensea margin-bottom-20" id="rangeSlider"></div>
                                ...
                                <div class="col-lg-4 col-md-12">
                                  ...
                                  <div class="form-group">
                                    <input type="text" class="form-control" id="datepicker" placeholder="Created Date">
                                  </div>
                                ...
                                <div class="col-lg-4 col-md-12">
                                  ...
                                  <div class="search-filters">
                                    <a href="http://tattek.sk/minimal/all" class="active">All</a>
                                    <a href="http://tattek.sk/minimal/document">Documents</a>
                                    <a href="http://tattek.sk/minimal/audio">Audio</a>
                                    <a href="http://tattek.sk/minimal/image">Images</a>
                                    <a href="http://tattek.sk/minimal/video">Videos</a>
                                  </div>
                      ...
                      <ul class="search-results files">
                        ...
                        <li class="search-result">
                          <div class="media cover">
                            <a href="search-results.html#" class="pull-left">
                              <img alt="" src="assets/images/carousel/carousel1.jpg" class="media-object">
                            </a>
                            <div class="media-body">
                              <h4><a href="search-results.html#">carousel1.jpg</a></h4>
                              <small>Type: JPG Image</small><br>
                              <small>Created: March 14, 2014 at 18:26</small><br>
                              <small>Author: Ing. Imrich Kamarel</small>
                            </div>
                          </div>
                        </li>
                        ...
                        <li class="search-result">
                          <div class="media cover">
                            ...
                            <div class="media-body">
                              <h4><a href="search-results.html#">PDF_document.pdf</a></h4>
                              <small>Type: PDF Document</small><br>
                              <small>Created: January 25, 2013 at 8:39</small><br>
                              <small>Author: Ing. Imrich Kamarel</small>
                            </div>
                          </div>
                        </li>
                        ...
                        <li class="search-result">
                          <div class="media cover">
                            ...
                            <div class="media-body">
                              <h4><a href="search-results.html#">MP3_file.mp3</a></h4>
                              <small>Type: MP3 File</small><br>
                              <small>Created: March 19, 2014 at 13:18</small><br>
                              <small>Author: Ing. Imrich Kamarel</small>
                            </div>
                          </div>
                        </li>
                        ...
                        <li class="search-result">
                          <div class="media cover">
                            ...
                            <div class="media-body">
                              <h4><a href="search-results.html#">Video.avi</a></h4>
                              <small>Type: AVI File</small><br>
                              <small>Created: March 11, 2014 at 14:33</small><br>
                              <small>Author: Ing. Imrich Kamarel</small>
                            </div>
                          </div>
                        </li>
                        ...
                        <li class="search-result">
                          <div class="media cover">
                            <a href="search-results.html#" class="pull-left">
                              <img alt="" src="assets/images/carousel/carousel2.jpg" class="media-object">
                            </a>
                            <div class="media-body">
                              <h4><a href="search-results.html#">carousel2.jpg</a></h4>
                              <small>Type: JPG Image</small><br>
                              <small>Created: March 26, 2014 at 16:21</small><br>
                              <small>Author: Ing. Imrich Kamarel</small>
                            </div>
                          </div>
                        </li>
                      ...
                      <ul class="search-results files">
                        ...
                        <li class="search-result">
                          <div class="media cover">
                            ...
                            <div class="media-body">
                              <h4><a href="search-results.html#">Ing. Imrich Kamarel</a></h4>
                              <small>Username: @icino</small><br>
                              <small>Privilegies: Administrator</small><br>
                              <small>Created at: 18.03.2013</small>
                            </div>
                          </div>
                        </li>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="search-results.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="search-results.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="search-results.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="search-results.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="search-results.html#">
