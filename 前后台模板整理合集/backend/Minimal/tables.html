...
<html>
  <head>
    <title>Minimal 1.3 - Tables</title>
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              <li class="divided">
                <a href="tables.html#" class="page-refresh"><i class="fa fa-refresh"></i></a>
              </li>
            </ul>
            <!-- /Page refresh -->
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="tables.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="tables.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="orange" href="tables.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="tables.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="tables.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided user" id="current-user">
                ...
                <a class="dropdown-toggle options" data-toggle="dropdown" href="tables.html#">
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <h3>Backgrounds:</h3>
                    <ul id="color-schemes">
                      <li><a href="tables.html#" class="bg-1"></a></li>
                      <li><a href="tables.html#" class="bg-2"></a></li>
                      <li><a href="tables.html#" class="bg-3"></a></li>
                      <li><a href="tables.html#" class="bg-4"></a></li>
                      <li><a href="tables.html#" class="bg-5"></a></li>
                      <li><a href="tables.html#" class="bg-6"></a></li>
                      <li class="title">Solid Backgrounds:</li>
                      <li><a href="tables.html#" class="solid-bg-1"></a></li>
                      <li><a href="tables.html#" class="solid-bg-2"></a></li>
                      <li><a href="tables.html#" class="solid-bg-3"></a></li>
                      <li><a href="tables.html#" class="solid-bg-4"></a></li>
                      <li><a href="tables.html#" class="solid-bg-5"></a></li>
                      <li><a href="tables.html#" class="solid-bg-6"></a></li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="tables.html#" class="video-bg-1"></a></li>
                      <li><a href="tables.html#" class="video-bg-2"></a></li>
                      <li><a href="tables.html#" class="video-bg-3"></a></li>
                      <li><a href="tables.html#" class="video-bg-4"></a></li>
                      <li><a href="tables.html#" class="video-bg-5"></a></li>
                      <li><a href="tables.html#" class="video-bg-6"></a></li>
                      <li><a href="tables.html#" class="video-bg-7"></a></li>
                      <li><a href="tables.html#" class="video-bg-8"></a></li>
                      <li><a href="tables.html#" class="video-bg-9"></a></li>
                      <li><a href="tables.html#" class="video-bg-10"></a></li>
                    </ul>
                  ...
                  <li>
                    <a href="tables.html#"><i class="fa fa-user"></i> Profile</a>
                  </li>

                  <li>
                    <a href="tables.html#"><i class="fa fa-calendar"></i> Calendar</a>
                  </li>

                  <li>
                    <a href="tables.html#"><i class="fa fa-envelope"></i> Inbox <span class="badge badge-red" id="user-inbox">3</span></a>
                  </li>

                  <li class="divider"></li>

                  <li>
                    <a href="tables.html#"><i class="fa fa-power-off"></i> Logout</a>
                  </li>
                </ul>
              </li>

              <li>
                <a href="tables.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="tables.html#" class="sidebar-toggle" data-toggle="#navigation">Navigation <i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    <a href="tables.html#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="tables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="tables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="tables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="tables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="tables.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="tables.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="tables.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>

                <div class="media">
                  <a class="pull-right" href="tables.html#">
              ...
              <li class="settings" id="general-settings">
                <a href="tables.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header">
                    ...
                    <div class="controls">
                      <a href="tables.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tables.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tables.html#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
                  </div>
                  <!-- /tile header -->
                ...
                <section class="tile">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Bordered</strong> Table</h1>
                    <div class="controls">
                      <a href="tables.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tables.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tables.html#" class="remove"><i class="fa fa-times"></i></a>
                    ...
                    <table class="table table-bordered table-sortable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Otto</td>
                          <td>@mdo</td>
                          <td><a href="tables.html#" class="check-toggler checked"></a></td>
                        </tr>
                        <tr>
                          <td>
                            <div class="checkbox check-transparent">
                          ...
                          <td>Thornton</td>
                          <td>@fat</td>
                          <td><a href="tables.html#" class="check-toggler"></a></td>
                        </tr>
                        <tr>
                          <td>
                            <div class="checkbox check-transparent">
                    ...
                    <div class="row">  
                      ...
                      <div class="col-sm-4 text-right sm-center">
                        <ul class="pagination pagination-xs nomargin pagination-custom">
                          <li class="disabled"><a href="tables.html#"><i class="fa fa-angle-double-left"></i></a></li>
                          ...
                          <li><a href="tables.html#"><i class="fa fa-angle-double-right"></i></a></li>
                        </ul>
                      </div>
              ...
              <div class="col-md-6">
                ...
                <section class="tile color transparent-white">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Striped</strong> Rows</h1>
                    <div class="controls">
                      <a href="tables.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tables.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tables.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Hover</strong> Rows</h1>
                    <div class="controls">
                      <a href="tables.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tables.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tables.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile color greensea">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Responsive</strong> Table</h1>
                    <div class="controls">
                      <a href="tables.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tables.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tables.html#" class="remove"><i class="fa fa-times"></i></a>
                ...
                <section class="tile color transparent-white">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Custom</strong> Table</h1>
                    <div class="search">
                      <input type="text" placeholder="Search...">
                    </div>
                    <div class="controls">
                    ...
                    <table class="table table-custom table-sortable">
                      <thead>
                        <tr>
                          ...
                          <th class="sortable sort-asc">First Name</th>
                          <th class="sortable sort-numeric">Last Name</th>
                          <th class="sortable sort-amount">Username</th>
                          <th style="width: 30px;"></th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          ...
                          <td>Otto</td>
                          <td>@mdo</td>
                          <td class="text-center"><a href="tables.html#" class="check-toggler checked"></a></td>
                        </tr>
                        <tr>
                          <td>
                            <div class="checkbox check-transparent">
                          ...
                          <td>Thornton</td>
                          <td>@fat</td>
                          <td class="text-center"><a href="tables.html#" class="check-toggler"></a></td>
                        </tr>
                        <tr>
                          <td>
                            <div class="checkbox check-transparent">
              ...
              <div class="col-md-12">
                ...
                <section class="tile">
                  ...
                  <!-- tile header -->
                  <div class="tile-header">
                    <h1><strong>Contextual</strong> Classes</h1>
                    <div class="controls">
                      <a href="tables.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="tables.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="tables.html#" class="remove"><i class="fa fa-times"></i></a>
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="tables.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="tables.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="tables.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="tables.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="tables.html#">
