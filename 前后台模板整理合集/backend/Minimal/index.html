      ...
      <div class="row">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <a class="dropdown-toggle button" data-toggle="dropdown" href="index.html#">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li><a href="index.html#">Check all tasks <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wider arrow nopadding messages">
                  ...
                  <li>
                    <a class="orange" href="index.html#">
                      <div class="profile-photo">
                  ...
                  <li class="topborder"><a href="index.html#">Check all messages <i class="fa fa-angle-right"></i></a></li>
                </ul>
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  ...
                  <li>
                   ...
                   <li><a href="index.html#">Check all notifications <i class="fa fa-angle-right"></i></a></li>
                </ul>
                ...
                <ul class="dropdown-menu arrow settings">
                  ...
                  <li>
                    ...
                    <ul id="videobackgrounds">
                      ...
                      <li><a href="index.html#" class="video-bg-1"></a></li>
                      <li><a href="index.html#" class="video-bg-2"></a></li>
                      <li><a href="index.html#" class="video-bg-3"></a></li>
                      <li><a href="index.html#" class="video-bg-4"></a></li>
                      <li><a href="index.html#" class="video-bg-5"></a></li>
                      <li><a href="index.html#" class="video-bg-6"></a></li>
                      <li><a href="index.html#" class="video-bg-7"></a></li>
                      <li><a href="index.html#" class="video-bg-8"></a></li>
                      <li><a href="index.html#" class="video-bg-9"></a></li>
                      <li><a href="index.html#" class="video-bg-10"></a></li>
                    </ul>
              ...
              <li>
                <a href="index.html#mmenu"><i class="fa fa-comments"></i></a>
              </li>
            </ul>
            <!-- /Quick Actions -->
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 1.1</a></li>

                      <li class="dropdown">
                        <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.2 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 2.3 <b class="fa fa-plus dropdown-plus"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li class="dropdown">
                                <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 3.3 <b class="fa fa-plus dropdown-plus"></b></a>
                                <ul class="dropdown-menu">
                                  <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 4.1</a></li>
                                   <li class="dropdown">
                                      <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 4.2 <b class="fa fa-plus dropdown-plus"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 5.1</a></li>
                                        <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 5.2</a></li>
                                      </ul>
                                    </li>
                                </ul>
                              </li>
                      ...
                      <li class="dropdown">
                        <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i> Menu Level 1.3 <b class="fa fa-plus dropdown-plus"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 2.1</a></li>
                          <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 2.2</a></li>
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 3.1</a></li>
                              <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 3.2</a></li>
                              <li><a href="index.html#"><i class="fa fa-caret-right"></i> Menu Level 3.3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
              ...
              <li class="summary" id="order-summary">
                <a href="index.html#" class="sidebar-toggle underline" data-toggle="#order-summary">Orders Summary <i class="fa fa-angle-up"></i></a>
              ...
              <li class="settings" id="general-settings">
                <a href="index.html#" class="sidebar-toggle underline" data-toggle="#general-settings">General Settings <i class="fa fa-angle-up"></i></a>
              ...
              <div class="col-lg-8 col-md-12">
                ...
                <section class="tile transparent">
                  ...
                  <div class="tile-header color transparent-black textured rounded-top-corners">
                    ...
                    <div class="controls">
                      <a href="index.html#" class="minimize"><i class="fa fa-chevron-down"></i></a>
                      <a href="index.html#" class="refresh"><i class="fa fa-refresh"></i></a>
                      <a href="index.html#" class="remove"><i class="fa fa-times"></i></a>
                    </div>
                  </div>
                  <!-- /tile header -->
                ...
                <section class="tile transparent recent-activity">
                  ...
                  <div class="tile-widget color transparent-black rounded-top-corners nopadding">
                    ...
                    <ul class="nav nav-tabs tabdrop">
                      ...
                      <li><a href="index.html#orders-tab" data-toggle="tab">Orders</a></li>
                      <li><a href="index.html#messages-tab" data-toggle="tab">Messages</a></li>
                      <li><a href="index.html#tasks-tab" data-toggle="tab">Tasks</a></li>
                      <li><a href="index.html#comments-tab" data-toggle="tab">Comments</a></li>
                    </ul>
                    <!-- / Nav tabs -->
                  </div>
                  <!-- /tile widget -->
              ...
              <div class="col-md-6">
                ...
                <section class="tile transparent">
                  ...
                  <div class="tile-footer rounded-bottom-corners text-right">
                    <a class="submit font-slab" href="index.html#"><strong>Send</strong> message <i class="fa fa-comment"></i></a>
                  </div>
                  <!-- /tile footer -->
        ...
        <div id="mmenu" class="right-panel">
          ...
          <ul class="nav nav-tabs nav-justified">
            <li class="active"><a href="index.html#mmenu-users" data-toggle="tab"><i class="fa fa-users"></i></a></li>
            <li class=""><a href="index.html#mmenu-history" data-toggle="tab"><i class="fa fa-clock-o"></i></a></li>
            <li class=""><a href="index.html#mmenu-friends" data-toggle="tab"><i class="fa fa-heart"></i></a></li>
            <li class=""><a href="index.html#mmenu-settings" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="mmenu-users">
              ...
              <ul class="users-list">
                ...
                <li class="online">
                  <div class="media">
                    <a class="pull-left profile-photo" href="index.html#">
