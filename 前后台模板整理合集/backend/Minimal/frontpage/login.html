...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>Minimal - Front Page Template / Login</title>
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-mega" data-init="onHover">
              <a href="login.html#" class="dropdown-toggle" data-toggle="dropdown" data-0="padding: 30px 25px 22px;border-bottom-width:4px;" data-100="padding: 24px 25px 16px;border-bottom-width:3px;" data-200="padding: 15px 25px 12px;border-bottom-width:2px;" data-300="padding: 15px 25px 10px;border-bottom-width:1px;">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <form class="form-horizontal" role="form">
              ...
              <div class="row">
                <div class="col-xs-6 col-lg-4 col-lg-offset-4">
                  <button type="submit" class="btn btn-theme">Login</button>
                </div>
                <div class="col-xs-6 col-lg-4 text-right">
                  <a href="login.html#" class="small-link">Forget Password?</a>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-8 col-md-offset-4">
                  ...
                  <div class="social-login">
                    ...
                    <a href="login.html#"><span class="overlay bg-blue"></span><i class="fa fa-facebook" style="padding-left: 14px;"></i></a>
                    <a href="login.html#"><span class="overlay bg-red"></span><i class="fa fa-google-plus" style="padding-left: 10px;"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="widget widget-contact">
                ...
                <address>
                  ...
                  <strong>Skype:</strong> <a href="login.html#">tattek</a>
                </address>
              </div>
              ...
              <div class="widget widget-social">
                ...
                <a href="login.html#"><span class="overlay bg-blue"></span><i class="fa fa-facebook" style="padding-left: 14px;"></i></a>
                <a href="login.html#"><span class="overlay bg-red"></span><i class="fa fa-google-plus" style="padding-left: 10px;"></i></a>
                <a href="login.html#"><span class="overlay"></span><i class="fa fa-flickr" style="padding-left: 10px;"></i></a>
                <a href="login.html#"><span class="overlay bg-hotpink"></span><i class="fa fa-dribbble" style="padding-left: 10px;"></i></a>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 copyright">
              &copy; Copyright 2014 by <a href="login.html#">Minimal</a>. All Rights Reserved.
            </div>
