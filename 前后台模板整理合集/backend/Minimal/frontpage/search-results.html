...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>Minimal - Front Page Template / Search Results</title>
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-mega" data-init="onHover">
              <a href="search-results.html#" class="dropdown-toggle" data-toggle="dropdown" data-0="padding: 30px 25px 22px;border-bottom-width:4px;" data-100="padding: 24px 25px 16px;border-bottom-width:3px;" data-200="padding: 15px 25px 12px;border-bottom-width:2px;" data-300="padding: 15px 25px 10px;border-bottom-width:1px;">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            <ul class="pagination">
              <li><a href="search-results.html#" style="padding-left: 10px"><i class="fa fa-chevron-left"></i></a></li>
              <li><a href="search-results.html#">1</a></li>
              <li><a href="search-results.html#">2</a></li>
              <li><span>3</span></li>
              <li><a href="search-results.html#">4</a></li>
              <li><a href="search-results.html#">5</a></li>
              <li><a href="search-results.html#" style="padding-left: 14px"><i class="fa fa-chevron-right"></i></a></li>
            </ul>
          </div>
          <div class="col-md-4"></div>
        </div>
            ...
            <div class="col-md-4">
              ...
              <div class="widget widget-contact">
                ...
                <address>
                  ...
                  <strong>Skype:</strong> <a href="search-results.html#">tattek</a>
                </address>
              </div>
              ...
              <div class="widget widget-social">
                ...
                <a href="search-results.html#"><span class="overlay bg-blue"></span><i class="fa fa-facebook" style="padding-left: 14px;"></i></a>
                <a href="search-results.html#"><span class="overlay bg-red"></span><i class="fa fa-google-plus" style="padding-left: 10px;"></i></a>
                <a href="search-results.html#"><span class="overlay"></span><i class="fa fa-flickr" style="padding-left: 10px;"></i></a>
                <a href="search-results.html#"><span class="overlay bg-hotpink"></span><i class="fa fa-dribbble" style="padding-left: 10px;"></i></a>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 copyright">
              &copy; Copyright 2014 by <a href="search-results.html#">Minimal</a>. All Rights Reserved.
            </div>
