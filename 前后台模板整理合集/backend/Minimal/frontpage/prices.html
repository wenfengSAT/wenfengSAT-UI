...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>Minimal - Front Page Template / Prices</title>
  ...
  <!--/Preloader -->
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-mega" data-init="onHover">
              <a href="prices.html#" class="dropdown-toggle" data-toggle="dropdown" data-0="padding: 30px 25px 22px;border-bottom-width:4px;" data-100="padding: 24px 25px 16px;border-bottom-width:3px;" data-200="padding: 15px 25px 12px;border-bottom-width:2px;" data-300="padding: 15px 25px 10px;border-bottom-width:1px;">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <h1 class="headline"><strong>We are</strong> free!</h1>
    ...
    <!-- FOUR TABLES-->
    <section class="section no-top-padding appear-el" data-animation="fadeInLeft">
      <div class="container">
        <h3 class="uppercase no-top-margin"><strong>Four</strong> Tables</h3>
        <h5 class="subheading">with most popular tag</h5>
          ...
          <div class="pricing-tables">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="plan">
                ...
                <!-- plan type -->
                <div class="plan-type">
                  <h4 class="uppercase"><strong>Basic</strong> Plan</h4>
                </div>
                <!-- end plan type -->

                <!-- plan pricing -->
                <div class="plan-pricing">
                  <strong>$</strong> <span class="price">3</span>.99 <span>/ per month</span>
                </div>
                <!-- end plan pricing -->
                ...
                <div class="order-btn"><a class="btn" href="prices.html#">Buy Now</a></div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="plan popular">
                 ...
                 <!-- START RIBBON -->
                <div class="ribbon ribbon-small ribbon-black no-border">
                  <div class="banner">
                ...
                <!-- plan type -->
                <div class="plan-type">
                  <h4 class="uppercase"><strong>Premium</strong> Plan</h4>
                </div>
                <!-- end plan type -->

                <!-- plan pricing -->
                <div class="plan-pricing">
                  <strong>$</strong> <span class="price">6</span>.99 <span>/ per month</span>
                </div>
                <!-- end plan pricing -->
            ...
            <div class="col-md-3 col-sm-6">
              <div class="plan">
                ...
                <!-- plan type -->
                <div class="plan-type">
                  <h4 class="uppercase"><strong>Proffesional</strong> Plan</h4>
                </div>
                <!-- end plan type -->

                <!-- plan pricing -->
                <div class="plan-pricing">
                  <strong>$</strong> <span class="price">9</span>.99 <span>/ per month</span>
                </div>
                <!-- end plan pricing -->
            ...
            <div class="col-md-3 col-sm-6">
              <div class="plan">
                ...
                <!-- plan type -->
                <div class="plan-type">
                  <h4 class="uppercase"><strong>Ultimate</strong> Plan</h4>
                </div>
                <!-- end plan type -->

                <!-- plan pricing -->
                <div class="plan-pricing">
                  <strong>$</strong> <span class="price">19</span>.99 <span>/ per month</span>
                </div>
                <!-- end plan pricing -->
    ...
    <!-- THREE TABLES-->
    <section class="section no-top-padding appear-el"  data-animation="fadeInRight">
      <div class="container">
        <h3 class="uppercase no-top-margin"><strong>Three</strong> Tables</h3>
            ...
            <div class="col-md-4">
              ...
              <div class="widget widget-contact">
                ...
                <address>
                  ...
                  <strong>Skype:</strong> <a href="prices.html#">tattek</a>
                </address>
              </div>
              ...
              <div class="widget widget-social">
                ...
                <a href="prices.html#"><span class="overlay bg-blue"></span><i class="fa fa-facebook" style="padding-left: 14px;"></i></a>
                <a href="prices.html#"><span class="overlay bg-red"></span><i class="fa fa-google-plus" style="padding-left: 10px;"></i></a>
                <a href="prices.html#"><span class="overlay"></span><i class="fa fa-flickr" style="padding-left: 10px;"></i></a>
                <a href="prices.html#"><span class="overlay bg-hotpink"></span><i class="fa fa-dribbble" style="padding-left: 10px;"></i></a>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 copyright">
              &copy; Copyright 2014 by <a href="prices.html#">Minimal</a>. All Rights Reserved.
            </div>
