...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>Minimal - Front Page Template / Contacts</title>
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-mega" data-init="onHover">
              <a href="contacts.html#" class="dropdown-toggle" data-toggle="dropdown" data-0="padding: 30px 25px 22px;border-bottom-width:4px;" data-100="padding: 24px 25px 16px;border-bottom-width:3px;" data-200="padding: 15px 25px 12px;border-bottom-width:2px;" data-300="padding: 15px 25px 10px;border-bottom-width:1px;">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="block appear-el" data-animation="fadeInLeft">
              ...
              <h3 class="uppercase no-top-margin"><strong>Give Us</strong> a Line</h3>
              ...
              <form role="form">
                ...
                <button type="submit" class="btn btn-theme uppercase">Send</button>
                <button type="reset" class="btn uppercase">Cancel</button>
              </form>
          ...
          <div class="col-md-4">
             ...
             <div class="block appear-el" data-animation="fadeInRight">
              ...
              <h3 class="uppercase no-top-margin"><strong>Our</strong> office</h3>
              ...
              <address>
                ...
                <a href="contacts.html#">ici.kamarel@tattek.sk</a><br/>
                <a href="contacts.html#">support@tattek.sk</a>

                <div class="social">
                  <a href="contacts.html#" style="padding-left: 13px">
              ...
              <h3 class="uppercase no-top-margin"><strong>Business</strong> Hours</h3>
              <address>
            ...
            <div class="col-md-4">
              ...
              <div class="widget widget-contact">
                ...
                <address>
                  ...
                  <strong>Skype:</strong> <a href="contacts.html#">tattek</a>
                </address>
              </div>
              ...
              <div class="widget widget-social">
                ...
                <a href="contacts.html#"><span class="overlay bg-blue"></span><i class="fa fa-facebook" style="padding-left: 14px;"></i></a>
                <a href="contacts.html#"><span class="overlay bg-red"></span><i class="fa fa-google-plus" style="padding-left: 10px;"></i></a>
                <a href="contacts.html#"><span class="overlay"></span><i class="fa fa-flickr" style="padding-left: 10px;"></i></a>
                <a href="contacts.html#"><span class="overlay bg-hotpink"></span><i class="fa fa-dribbble" style="padding-left: 10px;"></i></a>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 copyright">
              &copy; Copyright 2014 by <a href="contacts.html#">Minimal</a>. All Rights Reserved.
            </div>
