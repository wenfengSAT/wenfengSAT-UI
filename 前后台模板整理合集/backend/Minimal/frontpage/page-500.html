...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>Minimal - Front Page Template / Page 500</title>
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-mega" data-init="onHover">
              <a href="page-500.html#" class="dropdown-toggle" data-toggle="dropdown" data-0="padding: 30px 25px 22px;border-bottom-width:4px;" data-100="padding: 24px 25px 16px;border-bottom-width:3px;" data-200="padding: 15px 25px 12px;border-bottom-width:2px;" data-300="padding: 15px 25px 10px;border-bottom-width:1px;">
    ...
    <section class="section error">
      <div class="container">
        ...
        <div class="row">
          ...
          <h1 class="error">Error <strong class="overline">500</strong></h1>

          <p class="lead">Whoops, a real big error here!</p>

          <p>our code is broken :-(</p>

          <div class="controls">
            <button class="btn btn-primary"><i class="fa fa-refresh"></i> Try Again</button>
            <button class="btn btn-success"><i class="fa fa-home"></i> Return to home</button>
            <button class="btn btn-danger"><i class="fa fa-envelope"></i> Contact Support</button>
          </div>
            ...
            <div class="col-md-4">
              ...
              <div class="widget widget-contact">
                ...
                <address>
                  ...
                  <strong>Skype:</strong> <a href="page-500.html#">tattek</a>
                </address>
              </div>
              ...
              <div class="widget widget-social">
                ...
                <a href="page-500.html#"><span class="overlay bg-blue"></span><i class="fa fa-facebook" style="padding-left: 14px;"></i></a>
                <a href="page-500.html#"><span class="overlay bg-red"></span><i class="fa fa-google-plus" style="padding-left: 10px;"></i></a>
                <a href="page-500.html#"><span class="overlay"></span><i class="fa fa-flickr" style="padding-left: 10px;"></i></a>
                <a href="page-500.html#"><span class="overlay bg-hotpink"></span><i class="fa fa-dribbble" style="padding-left: 10px;"></i></a>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 copyright">
              &copy; Copyright 2014 by <a href="page-500.html#">Minimal</a>. All Rights Reserved.
            </div>
