...
!function( $ ) {
	...
	var TabDrop = function(element, options) {
		...
		this.dropdown = $('<li class="dropdown hide pull-right tabdrop"><a class="dropdown-toggle" data-toggle="dropdown" href="#">'+options.text+'<span class="display-tab"></span> <b class="caret"></b></a><ul class="dropdown-menu right"></ul></li>')
