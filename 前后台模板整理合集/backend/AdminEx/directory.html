...
<section>
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            <h3>
                Directory Page <small>people directory</small>
            </h3>
            <ul class="breadcrumb">
                <li>
            ...
            <div class="directory-info-row">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="panel">
                            <div class="panel-body">
                                <h4>john Doe <span class="text-muted small"> - Frontend Developer</span></h4>
                                <div class="media">
                                    <a class="pull-left" href="#">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="panel">
                            <div class="panel-body">
                                <h4>Jonathan Smith <span class="text-muted small"> - CEO</span></h4>
                                <div class="media">
                                    <a class="pull-left" href="#">
                                        <img class="thumb media-object" src="images/photos/user3.png" alt="">
                                    </a>
                                    <div class="media-body">
                                        <address>
                                            <strong>ABCDE, Inc.</strong><br>
