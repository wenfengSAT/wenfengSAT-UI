            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href=""><i class="fa fa-tasks"></i> <span>Forms</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li class="active"><a href="inline_editors.html"> Inline Editors</a></li>
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Inline Editors </li>
            </ul>
        </div>
        <!-- page heading end-->
                            ...
                            <div id="editor-container">
                                ...
                                <div id="columns">
                                    <div id="column1">
                                        <div contenteditable="true">
                                            <h3>
                                                AdminEx Resonsive Flat Admin Templates
                                            </h3>
                                            <p>
                                                <strong>
                                                    Lorem ipsum dolor sit amet dolor. Duis blandit vestibulum faucibus a, tortor.
