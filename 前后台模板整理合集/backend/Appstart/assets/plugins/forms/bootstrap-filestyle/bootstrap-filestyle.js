...
(function($) {"use strict";
	...
	Filestyle.prototype = {
		...
		icon : function(value) {
			if (value === true) {
				...
				if (this.options.icon) {
					...
					this.$elementFilestyle.find('.filestyleicon').remove();
				}
			} else {
		...
		iconName : function(value) {
			if (value !== undefined) {
				this.$elementFilestyle.find('.filestyleicon').attr({
		...
		htmlIcon : function() {
			if (this.options.icon) {
				return '<span class="filestyleicon ' + this.options.iconName + '"></span> ';
			} else {
				return '';
			}
		},
