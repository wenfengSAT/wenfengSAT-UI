...
<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400italic,600,700%7COpen+Sans:300,400,400italic,600,700"><link rel="stylesheet" href="assets/js/plugins/jquery-jvectormap/jquery-jvectormap.min.css">
...
<span class="font-w600 push-10-l">Joshua Munoz</span>
</span>
</div>
...
<li>
<a class="active" href="base_comp_maps_vector.php">Vector</a>
</li>
</ul>
</li>
<li>
...
</div><script src="assets/js/oneui.min-1.3.js"></script><script src="assets/js/plugins/jquery-jvectormap/jquery-jvectormap.min.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-au-mill-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-cn-mill-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-de-mill-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-europe-mill-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-fr-mill-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-in-mill-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-us-aea-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-world-mill-en.js"></script>
<script src="assets/js/plugins/jquery-jvectormap/maps/jquery-jvectormap-za-mill-en.js"></script>
<script src="assets/js/pages/base_comp_maps_vector.js"></script>
