...
<li>
<a class="active" href="frontend_features.php"><i class="si si-energy"></i><span class="sidebar-mini-hide">Features</span></a>
</li>
<li>
...
<div class="bg-image" style="background-image: url('assets/img/photos/photo17@2x.jpg');">
...
<img class="img-responsive visibility-hidden" data-toggle="appear" data-offset="-250" data-class="animated fadeInRight" src="assets/img/various/promo3.jpg" alt="">
</div>
</div>
</section>
</div>
...
</div><script src="assets/js/oneui.min-1.3.js"></script><script src="assets/js/plugins/chartjs/Chart.min.js"></script>
<script src="assets/js/pages/frontend_features.js"></script>
