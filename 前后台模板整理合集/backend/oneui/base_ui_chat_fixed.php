...
<i class="fa fa-circle text-success"></i> Donald Barnes
...
<li>
<a class="active" href="base_ui_chat_fixed.php">Fixed</a>
</li>
<li>
...
<div class="push-10"><img class="img-avatar img-avatar-thumb" src="assets/img/avatars/avatar13.jpg" alt="">
</div>
...
<div class="block">
<div class="block">
<div class="bg-image" style="background-image: url('assets/img/photos/photo27.jpg');">
<div class="block-content block-content-full bg-black-op text-center">
<div class="push-10"><img class="img-avatar img-avatar-thumb" src="assets/img/avatars/avatar5.jpg" alt="">
</div>
...
<li class="active">
<a href="#chat-window1">
<img class="img-avatar img-avatar16" src="assets/img/avatars/avatar1.jpg" alt="">
 <span class="push-5-l">Evelyn</span>
</a>
</li>
<li>
<a href="#chat-window2">
<img class="img-avatar img-avatar16" src="assets/img/avatars/avatar13.jpg" alt="">
...
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar3.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Emma Cooper
<div class="font-w400 text-muted"><small>Photographer</small></div>
</a>
</li>
<li>
...
<i class="fa fa-circle text-muted"></i> Ethan Howard
<div class="font-w400 text-muted"><small>Graphic Designer</small></div>
</a>
</li>
<li>
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar4.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Linda Moore
<div class="font-w400 text-muted"><small>Web Designer</small></div>
</a>
</li>
<li>
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar14.jpg" alt="">
<i class="fa fa-circle text-muted"></i> John Parker
<div class="font-w400 text-muted"><small>Graphic Designer</small></div>
</a>
</li>
<li>
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar2.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Sara Holland
<div class="font-w400 text-muted"><small>Web Developer</small></div>
</a>
</li>
</ul>
...
</div><script src="assets/js/oneui.min-1.3.js"></script><script src="assets/js/pages/base_ui_chat.js"></script>
