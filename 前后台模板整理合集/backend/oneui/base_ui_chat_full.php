...
<ul>
<li>
<a class="active" href="base_ui_chat_full.php">Full</a>
</li>
<li>
...
</header><main id="main-container"><div class="js-chat-container content content-full" data-chat-mode="full">
<div class="block remove-margin-b">
<ul class="js-chat-head nav nav-tabs" data-toggle="tabs">
<li class="active">
<a href="#chat-window1">
<img class="img-avatar img-avatar16" src="assets/img/avatars/avatar6.jpg" alt="">
...
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar15.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Adam Hall
<div class="font-w400 text-muted"><small>Web Developer</small></div>
</a>
</li>
<li>
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar7.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Lisa Gordon
<div class="font-w400 text-muted"><small>Photographer</small></div>
</a>
</li>
<li>
...
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar7.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Tiffany Kim
<div class="font-w400 text-muted"><small>Web Designer</small></div>
</a>
</li>
<li>
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar10.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Ryan Hall
<div class="font-w400 text-muted"><small>Graphic Designer</small></div>
</a>
</li>
<li>
<a href="javascript:void(0)">
<img class="img-avatar" src="assets/img/avatars/avatar2.jpg" alt="">
<i class="fa fa-circle text-muted"></i> Ann Parker
<div class="font-w400 text-muted"><small>Web Developer</small></div>
</a>
</li>
</ul>
