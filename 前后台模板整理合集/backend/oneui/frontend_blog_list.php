...
<body><div id="page-container" class="sidebar-l sidebar-mini sidebar-o side-scroll header-navbar-fixed header-navbar-transparent">
<nav id="sidebar">
...
<ul>
<li>
<a href="frontend_home.php">Default Navigation</a>
</li>
<li>
<a href="frontend_home_header_nav.php">Header Navigation</a>
</li>
</ul>
</li>
<li>
<a href="frontend_features.php"><i class="si si-energy"></i><span class="sidebar-mini-hide">Features</span></a>
</li>
<li>
<a href="frontend_pricing.php"><i class="si si-wallet"></i><span class="sidebar-mini-hide">Pricing</span></a>
</li>
<li>
<a href="frontend_contact.php"><i class="si si-envelope-open"></i><span class="sidebar-mini-hide">Contact</span></a>
</li>
<li>
...
<li>
<a href="frontend_login.php">Log In</a>
</li>
<li>
...
<ul>
<li>
<a href="frontend_blog_classic.php">Classic</a>
</li>
<li>
<a class="active" href="frontend_blog_list.php">List</a>
</li>
<li>
<a href="frontend_blog_grid.php">Grid</a>
</li>
<li>
<a href="frontend_blog_story.php">Story</a>
</li>
<li>
<a href="frontend_blog_story_cover.php">Story Cover</a>
</li>
</ul>
</li>
<li>
...
<ul>
<li>
<a href="frontend_elearning_courses.php">Courses</a>
</li>
<li>
<a href="frontend_elearning_course.php">Course</a>
</li>
<li>
<a href="frontend_elearning_lesson.php">Lesson</a>
</li>
</ul>
</li>
<li class="nav-main-heading"><span class="sidebar-mini-hide">Apps</span></li>
<li>
<a href="index.php"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Backend</span></a>
</li>
</ul>
</div>
</div>
</div>
</nav><header id="header-navbar" class="content-mini content-mini-full hidden-md hidden-lg">
...
</header><main id="main-container"><div class="bg-image" style="background-image: url('assets/img/photos/photo18@2x.jpg');">
...
<img class="img-responsive hidden-xs" src="assets/img/photos/photo21.jpg" alt="">
<div class="block-content">
<div class="font-s12 push">
<em class="pull-right">10 min</em>
<span class="text-primary">Jack Greene</span> on July 16, 2015
</div>
...
<div class="push visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
<a class="block block-link-hover2" href="frontend_blog_story.php">
<img class="img-responsive hidden-xs" src="assets/img/photos/photo22.jpg" alt="">
<div class="block-content">
<div class="font-s12 push">
<em class="pull-right">15 min</em>
<span class="text-primary">Evelyn Willis</span> on July 13, 2015
</div>
...
<div class="push visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
<a class="block block-link-hover2" href="frontend_blog_story.php">
<img class="img-responsive hidden-xs" src="assets/img/photos/photo23.jpg" alt="">
<div class="block-content">
<div class="font-s12 push">
<em class="pull-right">12 min</em>
<span class="text-primary">Susan Elliott</span> on July 6, 2015
</div>
...
<div class="push visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
<a class="block block-link-hover2" href="frontend_blog_story.php">
<img class="img-responsive hidden-xs" src="assets/img/photos/photo24.jpg" alt="">
<div class="block-content">
<div class="font-s12 push">
<em class="pull-right">9 min</em>
<span class="text-primary">Jack Greene</span> on June 21, 2015
</div>
...
<div class="push visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
<a class="block block-link-hover2" href="frontend_blog_story.php">
<img class="img-responsive hidden-xs" src="assets/img/photos/photo4.jpg" alt="">
<div class="block-content">
<div class="font-s12 push">
<em class="pull-right">5 min</em>
<span class="text-primary">Laura Bell</span> on June 16, 2015
</div>
...
<div class="push visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
<a class="block block-link-hover2" href="frontend_blog_story.php">
<img class="img-responsive hidden-xs" src="assets/img/photos/photo6.jpg" alt="">
<div class="block-content">
<div class="font-s12 push">
<em class="pull-right">3 min</em>
<span class="text-primary">Jack Greene</span> on June 1, 2015
</div>
...
</div><script src="assets/js/oneui.min-1.3.js"></script><script>jQuery(function(){App.initHelpers('appear');});</script>
