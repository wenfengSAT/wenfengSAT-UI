...
<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400italic,600,700%7COpen+Sans:300,400,400italic,600,700"><link rel="stylesheet" href="assets/js/plugins/highlightjs/github-gist.min.css">
...
<li>
<a class="active" href="base_comp_syntax_highlighting.php">Syntax Highlighting</a>
</li>
<li>
...
</div><script src="assets/js/oneui.min-1.3.js"></script><script src="assets/js/plugins/highlightjs/highlight.pack.js"></script>
<script>jQuery(function(){App.initHelpers('highlightjs');});</script>
