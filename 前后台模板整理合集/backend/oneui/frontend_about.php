...
<li>
<a class="active" href="frontend_about.php">About</a>
</li>
<li>
...
</header><main id="main-container"><div class="bg-primary-dark">
...
<ul class="nav-users push-10-t push">
    ...
    <li>
        <a href="base_pages_profile.php">
            ...
            <i class="fa fa-circle text-success"></i> Walter Fox
...
<div class="h4 text-white-op push-10-t push-5">Rebecca Gray</div>
...
<div class="h4 text-white-op push-10-t push-5">Eugene Burke</div>
...
<div class="h4 text-white-op push-10-t push-5">Sara Holland</div>
...
<img class="img-avatar img-avatar-thumb" src="assets/img/avatars/avatar11.jpg" alt="">
<div class="h4 text-white-op push-10-t push-5">Bruce Edwards</div>
...
<div class="h4 text-white-op push-10-t push-5">Scott Ruiz</div>
