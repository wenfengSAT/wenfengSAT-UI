...
<li>
<a class="active" href="base_comp_scrolling.php">Scrolling</a>
</li>
<li>
...
</div><script src="assets/js/oneui.min-1.3.js"></script><script>jQuery(function(){App.initHelpers('slimscroll');});</script>
