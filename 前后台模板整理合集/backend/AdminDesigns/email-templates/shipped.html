...
<head>
  ...
  <title>AdminDesigns Email Template - Shipped</title>
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href="shipped.html"><img width="167" height="35" src="img/logo.png" alt="logo"></a>
                    </td>
                    <td class="pull-right mobile-header-padding-right" style="color: #4d4d4d;">
                      <a href="shipped.html"><img width="40" height="47" src="img/social-twitter.png" alt="twitter" /></a>
                      <a href="shipped.html"><img width="40" height="47" src="img/social-fb.png" alt="facebook" /></a>
                      <a href="shipped.html"><img width="40" height="47" src="img/social-feed.png" alt="rss" /></a>
                    </td>
                  </tr>
                </table>
              </center>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              We wanted to let you know that we just shipped off your order <a href="shipped.html">#23141</a>. You'll find all the details below.
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="http://"
              style="background-color:#4a89dc;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Track Order</a></div>
            </td>
          </tr>
          <tr>
            <td class="w320">
