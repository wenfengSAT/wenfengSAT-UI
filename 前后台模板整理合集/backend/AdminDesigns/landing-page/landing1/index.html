    ...
    <nav class="navbar navbar-default">
        ...
        <div class="topbar-nav clearfix">
            <div class="container">
                ...
                <ul class="topbar-right list-unstyled list-inline topbar-social">
                    ...
                    <li> <a href="index.html#"> <span class="fa fa-dribbble"></span> </a></li>
        ...
        <div class="container" style="max-width: 1050px;">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="index.html#page-top">AdminDesigns.</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="index.html#features-flat">Features</a>
                    </li>
                    <li>
    ...
    <header id="hero">
        <div class="container">
            <div class="intro-text">
                ...
                <a href="index.html#services" class="page-scroll btn btn-xl mr30 btn-primary">Learn More</a>
                <a href="index.html#contact" class="page-scroll btn btn-xl btn-wire">Contact Us</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 text-center">
	                ...
	                <a href="index.html#services" class="page-scroll btn btn-xl mr30 btn-primary pv15">Learn More</a>
	                <a href="index.html#contact" class="page-scroll btn btn-xl btn-danger pv15">Contact Us</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="index.html#portfolioModal1" class="portfolio-link" data-toggle="modal">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="index.html#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="index.html#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="index.html#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="index.html#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="index.html#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 hidden">
                    <ul class="list-inline quicklinks">
                        ...
                        <li><a href="index.html#">Terms of Use</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>
                                <strong>Want these icons in this portfolio item sample?</strong>You can download 60 of them for free, courtesy of <a href="index.html#">exampleDomain.com</a>, or you can purchase the 1500 icon set <a href="index.html#">here</a>.</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p><a href="index.html#">Startup Framework</a> is a website builder for professionals. Startup Framework contains components and complex blocks (PSD+HTML Bootstrap themes and templates) which can easily be integrated into almost any design. All of these components are made in the same style, and can easily be integrated into projects, allowing you to create hundreds of solutions for your future projects.</p>
                            <p>You can preview Startup Framework <a href="index.html#">here</a>.</p>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>Treehouse is a free PSD web template built by <a href="index.html#">Example Person</a>. This is bright and spacious design perfect for people or startup companies looking to showcase their apps or other projects.</p>
                            <p>You can download the PSD template in this portfolio sample item at <a href="index.html#">exampleDomain.com</a>.</p>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>Start Bootstrap's Agency theme is based on Golden, a free PSD website template built by <a href="index.html#">Example Person</a>. Golden is a modern and clean one page web template that was made exclusively for Best PSD Freebies. This template has a great portfolio, timeline, and meet your team sections that can be easily modified to fit your needs.</p>
                            <p>You can download the PSD template in this portfolio sample item at <a href="index.html#">exampleDomain.com</a>.</p>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>Escape is a free PSD web template built by <a href="index.html#">Example Person</a>. Escape is a one page web template that was designed with agencies in mind. This template is ideal for those looking for a simple one page solution to describe your business and offer your services.</p>
                            <p>You can download the PSD template in this portfolio sample item at <a href="index.html#">exampleDomain.com</a>.</p>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>Dreams is a free PSD web template built by <a href="index.html#">Example Person</a>. Dreams is a modern one page web template designed for almost any purpose. It’s a beautiful template that’s designed with the Bootstrap framework in mind.</p>
                            <p>You can download the PSD template in this portfolio sample item at <a href="index.html#">SampleDomain.com</a>.</p>
                            <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>
                        </div>
                    </div>
                </div>
