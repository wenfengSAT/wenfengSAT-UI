...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Notifications | Coco - Responsive Bootstrap Admin Template</title>   
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-warning'></i> Notifications</h1>
            		            	</div>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							<div class="widget-header transparent">
								<h2><strong>Notification</strong> Styles</h2>
							...
							<div class="widget-content padding">
								<div class="row">
									<div class="col-sm-4">
										<h4>Basic Styles</h4>
										<p>Most common notification types that are used in applications</p><br>
										<a class="btn btn-warning" href="javascript:;" onclick="notify('warning')">Warning</a>
										<a class="btn btn-danger" href="javascript:;" onclick="notify('error')">Error</a>
										<a class="btn btn-success" href="javascript:;" onclick="notify('success')">Success</a>
										<a class="btn btn-info" href="javascript:;" onclick="notify('info')">Info</a>
										<a class="btn btn-default bg-darkblue-2 border-darkblue-2" href="javascript:;" onclick="notify('cool')">Cool</a>
									</div>

									<div class="col-sm-4">
										<h4>Positioning</h4>
										<p>You can change the position of your notification boxes globally...</p><br>
										<div class="notification-positions">
											<div class="row">
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','top left')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','top center')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','top right')"></a></div>
											</div>
											<div class="row">
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','left middle')"></a></div>
												<div class="col-xs-4"><a class="bg-green-1"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','right middle')"></a></div>
											</div>
											<div class="row">
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','bottom left')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','bottom center')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify('cool','bottom right')"></a></div>
											</div>
										</div>
									</div>
									...
									<div class="col-sm-4">
										...
										<a class="btn btn-default" href="javascript:;" onclick="nconfirm()">Confirm</a>
								...
								<div class="row">
									<div class="col-sm-4 col-sm-offset-4">
										<p>...or position when wrapped around an object.</p><br>
										<div class="notification-positions">
											<div class="row">
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','top left')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','top center')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','top right')"></a></div>
											</div>
											<div class="row">
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','left middle')"></a></div>
												<div class="col-xs-4"><a class="bg-red-1"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','right middle')"></a></div>
											</div>
											<div class="row">
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','bottom left')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','bottom center')"></a></div>
												<div class="col-xs-4"><a class="bg-lightblue-1" href='javascript:;' onclick="notify2('cool','bottom right')"></a></div>
											</div>
										</div>
									</div>
