        ...
        <div class="container">
            <div id="main">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Alert & Progress Bar</li>
                </ol>
                <!-- end:breadcrumb -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="alert alert-warning alert-bordered alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="fa fa-times"></i></button>
                                    <strong>Warning!</strong> Better check yourself, you're not looking too good.
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="alert alert-success alert-square alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="fa fa-times"></i></button>
                                    <strong>Warning!</strong> Better check yourself, you're not looking too good.
                                </div>
                                <div class="alert alert-info alert-square alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="fa fa-times"></i></button>
                                    <strong>Warning!</strong> Better check yourself, you're not looking too good.
                                </div>
                                <div class="alert alert-warning alert-square alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="fa fa-times"></i></button>
                                    <strong>Warning!</strong> Better check yourself, you're not looking too good.
                                </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="alert alert-danger alert-outline alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="fa fa-times"></i></button>
                                    <strong>Warning!</strong> Better check yourself, you're not looking too good.
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    Progress Stripped Square
                                </h3>
                            </div>
                            <div class="panel-body">
                                <div class="progress progress-striped progress-square">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                                        60%
                                    </div>
                                </div>
