...
<body>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="slider slider-horizontal" style="width: 140px;">
                                    <input type="text" class="span2" value="4" id="slider1">
                                </div>
                            </div>  
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <b>€ 10</b> 
                                <div class="slider slider-horizontal" style="width: 414px;">
                                    <input type="text" class="span2" value="" data-slider-min="10" data-slider-max="1000" data-slider-step="5" data-slider-value="[250,450]" id="slider2"></div> 
                                    <b>€ 1000</b>
                            </div>  
                        </div>
    ...
    <!-- start:javascript for Srikandi admin -->
