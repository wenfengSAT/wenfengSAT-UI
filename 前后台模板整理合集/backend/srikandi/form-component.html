        ...
        <div class="container">
            <div id="main">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Form Component</li>
                </ol>
                <!-- end:breadcrumb -->
                    ...
                    <div class="col-lg-6">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <a href="#myModal-1" data-toggle="modal" class="btn btn-drop btn-warning">
                                    Form in Modal 2
                                </a>
                                <a href="#myModal-2" data-toggle="modal" class="btn btn-drop btn-danger">
                                    Form in Modal 3
                                </a>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal tasi-form" method="get">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group m-bot15">
                                                <span class="input-group-addon input-group-addon-primary">@</span>
                                                <input type="text" class="form-control" placeholder="Username">
                                            </div>

                                            <div class="input-group m-bot15">
                                                <input type="text" class="form-control">
                                                <span class="input-group-addon input-group-addon-danger">.00</span>
                                            </div>

                                            <div class="input-group m-bot15">
                                                <span class="input-group-addon input-group-addon-default">$</span>
                                                <input type="text" class="form-control">
                                                <span class="input-group-addon input-group-addon-warning">.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <div class="input-group input-group-sm m-bot15">
                                                <span class="input-group-addon input-group-addon-info">@</span>
                                                <input type="text" class="form-control" placeholder="Username">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group m-bot15">
                                                <span class="input-group-addon input-group-addon-primary">
                                                    <input type="checkbox">
                                                </span>
                                                <input type="text" class="form-control">
                                            </div>
