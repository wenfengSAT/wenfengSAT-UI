        ...
        <div class="container">
            <div id="main">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Jumbroton & Thumbnail</li>
                </ol>
                <!-- end:breadcrumb -->
                ...
                <div class="row">
                    <dic class="col-lg-12">
                        ...
                        <div class="jumbotron jumbotron-square">
                            <h1>Hello, world!</h1>
                            <p>This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                            <p><a class="btn btn-primary btn-lg" role="button">Learn more</a></p>
                        </div>
                        <div class="jumbotron jumbotron-sm">
                            <h1>Hello, world!</h1>
                            <p>This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                            <p><a class="btn btn-primary btn-sm" role="button">Learn more</a></p>
                        </div>
                    </dic>  
                </div>
                ...
                <div class="row" id="demo-thumbnail">
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a href="#" class="thumbnail">
                                        <img src="img/content/images5.JPG" class="img-responsive" alt="...">
                                    </a>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a href="#" class="thumbnail">
                                        <img src="img/content/images2.jpg" class="img-responsive" alt="...">
                                    </a>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a href="#" class="thumbnail">
                                        <img src="img/content/images3.JPG" class="img-responsive" alt="...">
                                    </a>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a href="#" class="thumbnail">
                                        <img src="img/content/images6.JPG" class="img-responsive" alt="...">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a href="#" class="thumbnail thumbnail-square">
                                        <img src="img/content/images5.JPG" class="img-responsive" alt="...">
                                    </a>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <h4>No Border Thumbnail</h4>
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a href="#" class="thumbnail thumbnail-no">
                                        <img src="img/content/images5.JPG" class="img-responsive" alt="...">
                                    </a>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
