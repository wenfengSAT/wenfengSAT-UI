        ...
        <div class="container">
            <div id="main">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Breadcrumb & Pagination</li>
                </ol>
                <!-- end:breadcrumb -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <h4>Square</h4>
                                <ul class="pagination pagination-primary pagination-square">
                                    <li><a href="#">«</a></li>
                                    <li><a href="#">1</a></li>
                                    <li><a href="#">2</a></li>
                                    <li><a href="#">3</a></li>
                            ...
                            <div class="panel-body">
                                <h4>Separated Square</h4>
                                <ul class="pagination pagination-primary pagination-squarated">
                                    <li><a href="#">«</a></li>
                                    <li><a href="#">1</a></li>
                                    <li><a href="#">2</a></li>
                                    <li><a href="#">3</a></li>
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <ul class="pager pager-square pager-danger">
                                    <li class="previous"><a href="#">&larr; Older</a></li>
                                    <li class="next"><a href="#">Newer &rarr;</a></li>
                                </ul>
                            </div>
