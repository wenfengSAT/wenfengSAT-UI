            ...
            <div id="main">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h5>Large devices Desktops (>=1200px) | Collapsed to start, horizontal above breakpoints</h5>
                        <div class="box">
                        ...
                        <h5>Medium devices Desktops (>=992px) | Collapsed to start, horizontal above breakpoints</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="box">
                                    .col-md-6
                        ...
                        <h5>Small devices Tablets (>=768px) | Collapsed to start, horizontal above breakpoints</h5>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="box">
                                    .col-sm-6
                        ...
                        <h5>Extra small devices. Phones (<768px) | Horizontal at all times</h5>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="box">
                                    .col-xs-6
