        ...
        <div class="container">
            <div id="main">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Princing Table</li>
                </ol>
                <!-- end:breadcrumb -->
                ...
                <div class="row princing-table">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="princing-body">
                            <div class="princing-head">
                                <h1><strong>Dia</strong>mond</h1>
                            ...
                            <div class="princing-footer">
                                <a href="#" class="btn btn-default btn-block">Get Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="princing-body">
                            <div class="princing-head">
                                <h1><strong>Plat</strong>inum</h1>
                                <h2><span>$</span> 4000</h2>
                            </div>
                            <ul>
                                <li>10 hours coverage</li>
                                <li>1000 digital images</li>
                                <li>500 A3 Hard Copy</li>
                                <li>Bridal portrait with 11X14</li>
                                <li>Engagement portrait with 11X14</li>
                                <li>Income Tax included</li>
                            </ul>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="princing-body princing-active">
                            <div class="princing-head">
                                <h1><strong>Go</strong>ld</h1>
                                <h2><span>$</span> 6000</h2>
                            </div>
                            <ul>
                                <li>10 hours coverage</li>
                                <li>1500 digital images</li>
                                <li>800 A3 Hard Copy</li>
                                <li>Bridal portrait with 11X14</li>
                                <li>Engagement portrait with 11X14</li>
                                <li>Income Tax included</li>
                            </ul>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="princing-body">
                            <div class="princing-head">
                                <h1><strong>Sil</strong>ver</h1>
                                <h2><span>$</span> 7000</h2>
                            </div>
                            <ul>
                                <li>28 hours coverage</li>
                                <li>2500 digital images</li>
                                <li>1000 A3 Hard Copy</li>
                                <li>Bridal portrait with 11X14</li>
                                <li>Engagement portrait with 11X14</li>
                                <li>Income Tax included</li>
                            </ul>
