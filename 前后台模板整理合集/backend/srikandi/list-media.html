                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <ul class="list-group list-group-item-square">
                                    <li class="list-group-item">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <header class="panel-title">
                                    Media Object Style 1
                                </header>
                            </div>
                            <div class="panel-body">
                                <ul class="media-list media-sm">
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-rounded" src="img/user/avatar-1.jpg" alt="Avatar">
                                        </a>
                                    ...
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-rounded" src="img/user/avatar-2.jpg" alt="Avatar">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                            <ul class="media-list">
                                                <li class="media">
                                                    <a class="pull-left" href="#fakelink">
                                                        <img class="media-object img-rounded" src="img/user/avatar-3.jpg" alt="Avatar">
                                                    </a>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">Media heading</h4>
                                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                                ...
                                                <li class="media">
                                                    <a class="pull-left" href="#fakelink">
                                                        <img class="media-object img-rounded" src="img/user/avatar-4.jpg" alt="Avatar">
                                                    </a>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">Media heading</h4>
                                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                    ...
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-rounded" src="img/user/avatar-5.jpg" alt="Avatar">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                    ...
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-rounded" src="img/user/avatar-6.jpg" alt="Avatar">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <ul class="media-list media-sm">
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-circle" src="img/user/avatar-4.jpg" alt="Avatar">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                    ...
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-circle" src="img/user/avatar-5.jpg" alt="Avatar">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                            <ul class="media-list">
                                                <li class="media">
                                                    <a class="pull-left" href="#fakelink">
                                                        <img class="media-object img-circle" src="img/user/avatar-6.jpg" alt="Avatar">
                                                    </a>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">Media heading</h4>
                                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                                ...
                                                <li class="media">
                                                    <a class="pull-left" href="#fakelink">
                                                        <img class="media-object img-circle" src="img/user/avatar-7.jpg" alt="Avatar">
                                                    </a>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">Media heading</h4>
                                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                    ...
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-circle" src="img/user/avatar-8.jpg" alt="Avatar">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
                                    ...
                                    <li class="media">
                                        <a class="pull-left" href="#fakelink">
                                            <img class="media-object img-circle" src="img/user/avatar-9.jpg" alt="Avatar">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Media heading</h4>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis.
