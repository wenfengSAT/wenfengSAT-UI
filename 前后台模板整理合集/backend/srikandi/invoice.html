                    ...
                    <div class="col-lg-12">
                        <div class="invoice-main">
                            <div class="invoice-head">
                                <div class="text-center">
                                    <h1><i class="fa fa-cubes"></i> <strong>Srikan</strong>di<strong>.</strong></h1>
                                </div>
                            </div>
                            <div class="invoice-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-8 col-xs-12 pull-right">
                                        <ul>
                                            <li>Total Amount : $7623</li>
                                            <li>Discount : 12%</li>
                                            <li>VAT : -----</li>
                                            <li>Total All : $7124</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="invoice-footer">
                                <div class="text-center">
                                    <a href="#" class="btn btn-primary"><i class="fa fa-mail-forward"></i> Submit Invoice</a>
                        ...
                        <div class="footer-invoice">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <hr>
                                    John Doe <br>
                                    44 Yogyakarta, Suite 231 <br>
                                    ASW, YK 1230<br>
                                    Tel: +12 (012) 123-352-345<br>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <h4>INVOICE INFO</h4>
                                    <hr>
                                    Invoice Number   : #98634<br>
                                    Invoice Date     : 2014-06-10<br>
                                    Due Date     : 2014-06-10<br>
                                    Invoice Status   : <span class="label label-danger">Unpaid</span>
                                </div>
                            </div>
                        </div>
                    </div>
