...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/lou-multi-select/css/multi-select.css">
...
<body>
        ...
        <div class="container">
            <div id="main">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Advanced Component</li>
                </ol>
                <!-- end:breadcrumb -->
                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <a href='#' class="btn btn-drop btn-xs btn-primary" id='select-all'>select all</a>
                                            <a href='#' class="btn btn-drop btn-xs btn-primary" id='deselect-all'>deselect all</a>
                                            <a href='#' class="btn btn-drop btn-xs btn-primary" id='select-100'>select 100 elems</a>
                                            <a href='#' class="btn btn-drop btn-xs btn-primary" id='deselect-100'>deselect 100 elems</a>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id='optgroup' multiple='multiple'>
                                            ...
                                            <optgroup label='Sumatra'>
                                                <option value='5' selected>Bengkulu</option>
                                                <option value='6' disabled>Lampung</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4>Custom headers and footers</h4>
                                        <select id='custom-headers' multiple='multiple'>
                                            ...
                                            <option value='yogyakarta'>Yogyakarta</option>
                                            <option value='bengkulu'>Bengkulu</option>
                                            <option value='maluku' selected>Maluku</option>
                                            <option value='jakarta'>Jakarta</option>
                                            <option value='bali'>Bali</option>
                                            <option value='lampung'>Lampung</option>
                                            <option value='kalimantan'>Kalimantan</option>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                                    <div class="form-group">
                                        <label class="col-sm-6 control-label">Default Date Picker</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" value="02-16-2014" id="dp1" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-6 control-label">Format Date Picker</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" value="02/16/14" data-date-format="mm/dd/yy" id="dp2" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-6 control-label">As component.</label>
                                        <div class="col-sm-6">
                                            <span class="input-group">
                                                <input type="text" disabled="disabled" class="form-control" value="12-02-2014">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary" data-date="12-02-2014" data-date-format="dd-mm-yyyy" id="dp3"  type="button"><i class="fa fa-calendar"></i></button>
                                                </span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-6 control-label">Limit the view mode to months</label>
                                        <div class="col-sm-6">
                                            <span class="input-group">
                                                <input type="text" disabled="disabled" class="form-control" value="12-02-2014">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary" id="dpMonths" data-date="102/2012" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months" type="button"><i class="fa fa-calendar"></i></button>
                                                </span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Start date <a href="#" class="btn btn-xs btn-primary" id="dp4" data-date-format="yyyy-mm-dd" data-date="2014-02-20">Change</a></th>
                                                        <th>End date <a href="#" class="btn btn-xs btn-primary" id="dp5" data-date-format="yyyy-mm-dd" data-date="2014-02-25">Change</a></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td id="startDate">2014-02-20</td>
                                                        <td id="endDate">2014-02-25</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Check in: <input type="text" class="form-control" value="" id="dpd1" ></th>
                                                        <th>Check out: <input type="text" class="form-control" value="" id="dpd2" ></th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        <label class="control-label col-md-6">Default Timepicker</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-6">24hr Timepicker</label>
                                        <div class="col-md-6">
                                            <div class="input-group bootstrap-timepicker">
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal  tasi-form" action="#">
                                    <div class="form-group">
                                        <label class="control-label col-md-6">Default</label>
                                        <div class="col-md-6">
                                            <input type="text" class="colorpicker-default form-control" value="#8fff00">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-6">As Component</label>
                                        <div class="col-md-6 col-xs-11">
                                            <div data-color-format="rgb" class="input-group colorpicker-default color">
    ...
    <script src="assets/lou-multi-select/js/jquery.multi-select.js"></script>
    ...
    <script src="js/advanced.component.js"></script>
