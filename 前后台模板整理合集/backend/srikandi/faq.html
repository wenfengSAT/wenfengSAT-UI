                ...
                <div class="row faq">
                    <div class="col-lg-4">
                        <ul class="nav nav-pills nav-stacked" style="max-width: 300px;">
                            <li class="active"><a href="#pentingiki" data-toggle="collapse" data-parent="#accordion" class="collapsed"><i class="fa fa-bank"></i> Penting Iki</a></li>
                            <li><a href="#peraturansampingan" data-toggle="collapse" data-parent="#accordion" class="collapsed"><i class="fa fa-asterisk"></i> Peraturan Sampingan</a></li>
                            <li><a href="#peraturanslengekan" data-toggle="collapse" data-parent="#accordion" class="collapsed"><i class="fa fa-anchor"></i> Peraturan Slengekan</a></li>
                            <li><a href="#kudutakon" data-toggle="collapse" data-parent="#accordion" class="collapsed"><i class="fa fa-info-circle"></i> Kudu Takon</a></li>
                            <li><a href="#singliyane" data-toggle="collapse" data-parent="#accordion" class="collapsed"><i class="fa fa-life-ring"></i> Sing Liyane</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-8">
                        <div class="panel-group" id="accordion">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#pentingiki" class="collapsed">
                                        <h4 class="panel-title">
                                            Penting Iki
                                        </h4>
                                    </a>
                                </div>
                                <div id="pentingiki" class="panel-collapse collapse" style="height: 0px;">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#peraturansampingan" class="collapsed">
                                        <h4 class="panel-title">
                                            Peraturan Sampingan
                                        </h4>
                                    </a>
                                </div>
                                <div id="peraturansampingan" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#peraturanslengekan" class="collapsed">
                                        <h4 class="panel-title">
                                            Peraturan Slengekan
                                        </h4>
                                    </a>
                                </div>
                                <div id="peraturanslengekan" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#kudutakon" class="collapsed">
                                        <h4 class="panel-title">
                                            Kudu Takon
                                        </h4>
                                    </a>
                                </div>
                                <div id="kudutakon" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#singliyane" class="collapsed">
                                        <h4 class="panel-title">
                                            Sing Liyane
                                        </h4>
                                    </a>
                                </div>
                                <div id="singliyane" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                    </div>
                                </div>
