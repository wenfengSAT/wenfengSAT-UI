	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			if (nodeValues[3].indexOf("#")>-1){
				var ss="<a href='#' onclick=\"parent.seldept('"+nodeValues[3].substr(1)+"','"+nodeValues[2]+"','"+nodeValues[4]+ "')\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"../../../images/orgtree/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />";
				document.write(ss);
			}else{
...
///////////////////////
			//add
			if (nodeValues[3].indexOf("#")>-1){
				document.write("<a href='#' onclick=\"parent.seldept('"+nodeValues[3].substr(1)+"','"+nodeValues[2]+"','"+nodeValues[4]+ "')\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\">");
			}else{
				document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\">");
			}
			//end
