...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			//document.write("<a href=\"" + nodeValues[3] + "\"  onclick=\"parent.seldept('all','"+nodeValues[2]+"','"+nodeValues[4]+ "');settextarea('"+nodeValues[3].substr(1)+"','"+nodeValues[2]+"')\"    onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"/images/orgtree/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br /><input type=checkbox name=sel value='"+nodeValues[3]+"'>");									
		    document.write("<input type=checkbox class=chkbox name=sel onclick=\"clickchkbox(this);return true;\" value='"+nodeValues[3].substr(1)+"'><a href=\"" + nodeValues[3] + "\"      onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"/images/orgtree/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");					
...
///////////////////////
			...
			if (nodeValues[3].indexOf("#")>-1){
				//document.write("<a href='#' onclick=\"parent.seldept('"+nodeValues[3].substr(1)+"','"+nodeValues[2]+"','"+nodeValues[4]+ "');settextarea('"+nodeValues[3].substr(1)+"','"+nodeValues[2]+"')\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><input type=checkbox name=sel value='"+nodeValues[3]+"'>");
				document.write("<a href='#'  onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><input type=checkbox class=chkbox onclick=\"clickchkbox(this);return true;\"  name=sel value='"+nodeValues[3].substr(1)+"'>");
			}else{
				document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\">");				
			}
			//end
