...
///////////////////////
			...
			// End link
			if (nodeValues[5]=="1"){
			document.write("</a><img class='specialimg' border='0' src='../../../images/delete_msg.gif' alt='É¾³ýÐÅÏ¢¼¯' onclick=\" delitem('"+nodeValues[7]+"','"+nodeValues[4]+"')\" ><br />");
			}
			else if (nodeValues[5]=="2"){
			document.write(":<font color=red>ÒÑ·¢²¼</font></a><br />");
			}
            else{
			document.write("</a><br />");
			}
