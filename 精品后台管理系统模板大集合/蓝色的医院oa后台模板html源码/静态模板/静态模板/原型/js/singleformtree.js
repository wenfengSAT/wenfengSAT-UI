	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			if (nodeValues[3].indexOf("#")>-1){
				var ss="<a href='#' onclick=\"parent.seldept('"+nodeValues[6]+"','"+nodeValues[2]+"','"+nodeValues[1]+ "','"+nodeValues[7]+ "')\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"/images/orgtree/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />";
				document.write(ss);
			}else{
...
///////////////////////
			...
			if (nodeValues[3].indexOf("#")>-1){
			  if (nodeValues[1]!="1"){
		      document.write("<a href='#' onclick=\"parent.seldept('"+nodeValues[6]+"','"+nodeValues[2]+"','"+nodeValues[1]+ "','"+nodeValues[7]+ "')\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\">");
			  }
			}else{
				document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\">");
			}
